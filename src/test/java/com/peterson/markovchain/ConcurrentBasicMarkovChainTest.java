 ...
 */
public class ConcurrentBasicMarkovChainTest
{
    ConcurrentBasicMarkovChain<Integer> chain;
    MockRandomNumberStrategy randomNumberStrategy;

    @Before
    public void setUp() throws Exception
    {
        chain = new ConcurrentBasicMarkovChain<>(Integer.MIN_VALUE, Integer.MAX_VALUE);
    }
